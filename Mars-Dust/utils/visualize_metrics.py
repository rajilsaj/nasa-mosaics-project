...
def visualize_model_metrics(model, X_test, y_test, y_pred, y_pred_proba, model_name, save_dir):
    """
    Create comprehensive visualizations for model metrics and save them to the specified directory.
    ...
    plt.figure(figsize=(10, 6))
    plt.hist(y_pred_proba[:, 1], bins=50, alpha=0.75)
...
def create_model_report(model_name, results_dir):
    """
    Create a comprehensive HTML report for the model using the saved metrics and visualizations.
