...
LABEL_DIR = r"/home/skabbo/datasets/cassini/Cassini Spacecraft/zenodo5004160/zenodo-3946033/labels/labels"
PREPROCESS_DIR = r"/home/skabbo/datasets/cassini/Cassini Spacecraft/preprocess"
OUT_DIR = r"/home/skabbo/datasets/cassini/Cassini Spacecraft/labels_2005"
# =================

WINDOW_MINUTES = 4
LABEL_MODE = "multiclass"  # use "multiclass" for your CNN-LSTM
DRY_RUN = False
...
def main() -> None:
    ...
    for _, row in df.iterrows():
        ...
        t_ns = np.load(t_path)
        t = pd.to_datetime(t_ns, utc=True)
        ...
        if has_bs:
            ...
            if bs_yaml is None:
                ...
                stats["bs_hits"] += apply_windows(y, t, cp_bs, 1)
        ...
        if has_mp:
            ...
            if mp_yaml is None:
                ...
                stats["mp_hits"] += apply_windows(y, t, cp_mp, 2)
